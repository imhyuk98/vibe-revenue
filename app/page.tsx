...
const games: Item[] = [
  ...
  { title: "베스킨라빈스 31", description: "1~3개씩 숫자를 부르고 31을 말하면 지는 게임! AI 대전 지원.", href: "/tools/baskin-robbins-31", emoji: "🍦" },
  { title: "초성 퀴즈", description: "랜덤 초성을 보고 해당하는 단어를 맞추는 퀴즈 게임입니다.", href: "/tools/chosung-quiz", emoji: "🔤" },
  { title: "이미지 게임", description: "'가장 ~할 것 같은 사람은?' 질문으로 즐기는 술자리 게임!", href: "/tools/image-game", emoji: "🖼️" },
  { title: "손병호 게임", description: "'나는 ~한 적 있다' 문장으로 서로를 알아가는 게임입니다.", href: "/tools/never-have-i-ever", emoji: "🖐️" },
  { title: "눈치 게임", description: "타이밍과 눈치로 숫자를 외치는 긴장감 넘치는 게임!", href: "/tools/nunchi-game", emoji: "👀" },
  { title: "텔레파시 게임", description: "같은 주제에 같은 답을 맞추는 마음 맞추기 게임입니다.", href: "/tools/telepathy-game", emoji: "🧠" },
