...
const allItems: Record<string, { title: string; href: string; category: string }> = {
  ...
  "rent-conversion": { title: "전월세 전환", href: "/calculators/rent-conversion", category: "부동산" },
  ...
  "blood-type": { title: "혈액형 계산기", href: "/calculators/blood-type", category: "재미" },
  ...
  zodiac: { title: "띠 계산기", href: "/calculators/zodiac", category: "재미" },
  ...
  "ladder-game": { title: "사다리 타기", href: "/tools/ladder-game", category: "술게임" },
  scientific: { title: "공학용 계산기", href: "/calculators/scientific", category: "생활" },
  "liar-game": { title: "라이어 게임", href: "/tools/liar-game", category: "술게임" },
  "truth-or-dare": { title: "진실 or 도전", href: "/tools/truth-or-dare", category: "술게임" },
  "bomb-game": { title: "폭탄 돌리기", href: "/tools/bomb-game", category: "술게임" },
  "updown-game": { title: "업다운 게임", href: "/tools/updown-game", category: "술게임" },
  "random-pick": { title: "랜덤 지목", href: "/tools/random-pick", category: "술게임" },
  ...
  "apple-game": { title: "사과 게임", href: "/tools/apple-game", category: "게임" },
  "planet-merge": { title: "행성 합치기", href: "/tools/planet-merge", category: "게임" },
  "baskin-robbins-31": { title: "베스킨라빈스 31", href: "/tools/baskin-robbins-31", category: "술게임" },
  "chosung-quiz": { title: "초성 퀴즈", href: "/tools/chosung-quiz", category: "술게임" },
  "image-game": { title: "이미지 게임", href: "/tools/image-game", category: "술게임" },
...
const relatedMap: Record<string, string[]> = {
  ...
  "liar-game": ["truth-or-dare", "bomb-game", "baskin-robbins-31", "ladder-game"],
  "truth-or-dare": ["liar-game", "random-pick", "never-have-i-ever", "bomb-game"],
  "bomb-game": ["updown-game", "liar-game", "random-pick", "nunchi-game"],
  "updown-game": ["bomb-game", "random-number", "liar-game", "baskin-robbins-31"],
  "random-pick": ["random-roulette", "truth-or-dare", "ladder-game", "liar-game"],
  ...
  "apple-game": ["game-2048", "sudoku", "minesweeper", "planet-merge"],
  "planet-merge": ["apple-game", "game-2048", "sudoku", "minesweeper"],
  scientific: ["percent", "unit-converter", "ratio", "gpa"],
  "baskin-robbins-31": ["nunchi-game", "updown-game", "bomb-game", "liar-game"],
  "chosung-quiz": ["telepathy-game", "typing-test", "image-game", "ladder-game"],
  "image-game": ["never-have-i-ever", "truth-or-dare", "chosung-quiz", "telepathy-game"],
