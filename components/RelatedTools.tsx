...
const allItems: Record<string, { title: string; href: string; category: string }> = {
  ...
  "reaction-test": { title: "반응속도 테스트", href: "/tools/reaction-test", category: "게임" },
  "color-blind-test": { title: "색맹 테스트", href: "/tools/color-blind-test", category: "게임" },
  ...
  "ladder-game": { title: "사다리 타기", href: "/tools/ladder-game", category: "게임" },
  "drinking-games": { title: "술게임 모음", href: "/tools/drinking-games", category: "게임" },
  scientific: { title: "공학용 계산기", href: "/calculators/scientific", category: "생활" },
  "liar-game": { title: "라이어 게임", href: "/tools/liar-game", category: "게임" },
  "truth-or-dare": { title: "진실 or 도전", href: "/tools/truth-or-dare", category: "게임" },
