...
const categoryMap: Record<string, { label: string; href?: string }> = {
  ...
  // Games
  "baskin-robbins-31": { label: "게임" },
  "chosung-quiz": { label: "게임" },
  "image-game": { label: "게임" },
  "never-have-i-ever": { label: "게임" },
  "nunchi-game": { label: "게임" },
  "telepathy-game": { label: "게임" },
  "liar-game": { label: "게임" },
